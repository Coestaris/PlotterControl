...
???????????????????? ????????????.";
        ...
        {
            return new CurveExample() { Discr = "???????????????????????????? ?????????????? ?????? a = 147,\nn = 1.66 ?????? \"???????????????????? ????????????????\"", image = PreviewImage(new Size(300, 300), 147, (double)1.66, 18) };
        }

        public static CurveExample Exmpl2()
        {
            return new CurveExample() { Discr = "???????????????????????????? ?????????????? ?????? a = 20,\nn = -1/2 ?????? \"??????????????????\"", image = PreviewImage(new Size(300, 300), 20, (double)-1/2, 44) };
        }
