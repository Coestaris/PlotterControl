...
?????????? M ???????? ???????????????? ?????????? a. ?????????? ?????????? ?????? ???????????????? ??????????????????.";
        ...
        {
            return new CurveExample() { Discr = "?????????????????? ?????? k = 50", image = PreviewImage(new Size(300, 300), 50, null,  20) };
        }

        public static CurveExample Exmpl2()
        {
            return new CurveExample() { Discr = "?????????????????? ?????? k = -500", image = PreviewImage(new Size(300, 300), -500, null,  5) };
        }
