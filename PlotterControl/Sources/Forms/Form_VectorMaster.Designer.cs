...
namespace CnC_WFA
{
    partial class Form_VectorMaster
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label_resolution.Text = "????????????????????: not set";
            // 
            // groupBox_rotate
            // 
            ...
            this.radioButton_hardbw.Text = "2?? ?????????????? ????????????";
            ...
            this.radioButton_grayform.Text = "?????????????? ????????????";
            ...
            this.label_gauss_sigma.Text = "??????????: 1.2";
            // 
