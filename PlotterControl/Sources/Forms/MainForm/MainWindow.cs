...
namespace CnC_WFA
{
    public partial class MainWindow : Form
    {
        ...
        {
            if (fs == null) fs = FormTranslator.Translate(new Form_SerialMonitor());
            if (!fs.Visible) { fs = FormTranslator.Translate(new Form_SerialMonitor()); fs.Show(); }
        }

        private void button2_Click_3(object sender, EventArgs e)
        {
            if (fp == null) fp = FormTranslator.Translate(new Form_PrintMaster());
            if (!fp.Visible) { fp = FormTranslator.Translate(new Form_PrintMaster()); fp.Show(); }
        }

        private void button4_Click_2(object sender, EventArgs e)
        {
            if (fm == null) fm = FormTranslator.Translate(new Form_ManualControl());
        ...
        {
            if (fv == null) fv = FormTranslator.Translate(new Form_VectorMaster());
            if (!fv.Visible) { fv = FormTranslator.Translate(new Form_VectorMaster()); fv.Show(); } else fv.Focus();
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            if (fvw == null) fvw = FormTranslator.Translate(new Form_ViewVect());
            if (!fvw.Visible) { fvw = FormTranslator.Translate(new Form_ViewVect()); fvw.Show(); }
        }
        
        private void button6_Click(object sender, EventArgs e)
        {
            if (fe == null) fe = FormTranslator.Translate(new Form_EditVector());
            if (!fe.Visible) { fe = FormTranslator.Translate(new Form_EditVector()); fe.Show(); }
        }
        ...
        {
            if (fc == null) fc = FormTranslator.Translate(new Form_CurvePlugins());
            if (!fc.Visible) { fc = FormTranslator.Translate(new Form_CurvePlugins()); fc.Show(); }
        }
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(
                string.Format(TB.L.Message["MainWindow.ClearingPrecompiledPlugins"], count), TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
            {
                if(fc != null && fc.Visible) { MessageBox.Show(TB.L.Error["MainWindow.ClosePlWin"], TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
                if(GlobalOptions.PreloadPlugins) { MessageBox.Show(TB.L.Error["MainWindow.DisablePreloadPlugins"], TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
                ...
                if (cantDelete.Count != 0) MessageBox.Show(string.Format(TB.L.Error["MainWindow.CantDeleteSomePlugins"], count - cantDelete.Count, cantDelete.Count, string.Join("\n  -", cantDelete)), TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.OK, MessageBoxIcon.Information);
                else MessageBox.Show(string.Format(TB.L.Message["MainWindow.SuccDeletePlugins"], count), TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void checkBox_main_config_preload_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(TB.L.Message["MainWindow.ForAccYouNeedReloadApp"], TB.L.Phrase["MainWindow.Plugins"], MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            if (fdl == null) fdl = FormTranslator.Translate(new Form_Dialog_Lang());
            if (!fdl.Visible) { fdl = FormTranslator.Translate(new Form_Dialog_Lang()); fdl.ShowDialog(); }
            else fdl.Focus();
        }

        private void button_vect_graph_open_Click(object sender, EventArgs e)
        {
            if (fg == null) fg = FormTranslator.Translate(new Form_Graph());
            if (!fg.Visible) { fg = FormTranslator.Translate(new Form_Graph()); fg.Show(); }
            else fg.Focus();
        }

        private void button2_Click_4(object sender, EventArgs e)
        {
            if (fme == null) fme = FormTranslator.Translate(new Form_Macro());
            if (!fme.Visible) { fme = FormTranslator.Translate(new Form_Macro()); fme.Show(); }
            else fme.Focus();
        }

        private void button1_Click_3(object sender, EventArgs e)
        {
            if (fmm == null) fmm = FormTranslator.Translate(new Form_MacroPack());
            if (!fmm.Visible) { fmm = FormTranslator.Translate(new Form_MacroPack()); fmm.Show(); }
            else fmm.Focus();
        }
        ...
        private void button_main_config_assoc_Click(object sender, EventArgs e)
        {
            ...
            {
                if (fda == null) fda = FormTranslator.Translate(new Form_Dialog_Assoc());
                if (!fda.Visible) { fda = FormTranslator.Translate(new Form_Dialog_Assoc()); fda.ShowDialog(); }
                else fda.Focus();
            }
        }
