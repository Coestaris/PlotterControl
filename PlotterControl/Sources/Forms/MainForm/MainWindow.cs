...
namespace CnC_WFA
{
    public partial class MainWindow : Form
    {
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("?????? ???????????? ?????? ?????????????????? ???????????????? ????????????????, ?????? ?????? ???????????????? ?????????????????? ?????????? ?????????????????? ???????????????? ???? ????????????????????.\n???? ?????????????????????????? ???????????? ?????????????? "+ count + " ???????????????????????? (????????????????????????????????) ?????????????????", "????????????????????????", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
            {
                if(fc != null && fc.Visible) { MessageBox.Show("?????? ?????????? ???????????????????? ?????????????? ???????????? ????????????", "????????????", MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
                if(GlobalOptions.PreloadPlugins) { MessageBox.Show("???????????????????? ???????????????? ??????, ?????????? ???????????????? ?????????????? ?????????????????????????????? ???????????????? ????????????????. ?????????????????? ???? ?? ?????????????????????????? ????????????????", "????????????", MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
                ...
                if (cantDelete.Count != 0) MessageBox.Show(string.Format("?????????????? ?????????????? {0} ??????????????????\n???????????????????? ?????????????? ?????????????????? ({1}):\n{2}", count - cantDelete.Count, cantDelete.Count, string.Join("\n  -", cantDelete)),"????????????????????", MessageBoxButtons.OK, MessageBoxIcon.Information);
                else MessageBox.Show(string.Format("?????????????? ?????????????? {0} ??????????????????", count), "????????????????????", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
