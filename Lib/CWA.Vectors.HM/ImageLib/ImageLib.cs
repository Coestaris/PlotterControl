...
{
    /// <summary>
    /// Предостовляет дополнительные методы для работы с изображениями.
    /// </summary>
    public class ImageLib
    {
        ...
        /// </summary>
        public ImageLibOptions Options { get; internal set; } = new ImageLibOptions();
